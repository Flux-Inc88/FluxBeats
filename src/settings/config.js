...
module.exports = {
    ...
    // RAINLINK DETAILS
    lavalinkSource: process.env.LAVALINK_SOURCE || "youtube", // Available Lavalink sources, based on the sources you've enabled in your Lavalink configuration. For example, if you enable the Spotify source, then "sp" will refer to "spsearch". Will be used if "sourceID" option is provided in the play command.
    rainlinkOptions: {
